...
public sealed class NestedDivPropertyTests
{
    ...
    // Balanced open/close/text operations keep the generated topology well formed. This isolates text dispatch
    // across concurrently active same-tag matches from the documented lexical/tree-construction boundary.
