...
<#
    Hosts the published app in IIS under a local hostname.
        ...
        dotnet publish streaming/samples/AngleSharp.ReadOnlyDom.HackerNews -c Release -o artifacts/iis/local-hackernews
        ./streaming/samples/AngleSharp.ReadOnlyDom.HackerNews/iis-setup.ps1        # elevated
