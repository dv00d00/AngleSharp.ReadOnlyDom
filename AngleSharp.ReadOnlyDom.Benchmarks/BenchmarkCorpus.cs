...
internal static class BenchmarkCorpus
{
    ...
    private static string FindCorpusDirectory()
    {
        ...
        {
            var candidate = Path.Combine(directory.FullName, "AngleSharp.ReadOnlyDom.Tests", "temp");
        ...
        throw new DirectoryNotFoundException(
            "Could not locate the checked-in AngleSharp.ReadOnlyDom.Tests/temp corpus."
        );
    }
}
