...
`dom/src/AngleSharp.ReadOnlyDom/Generated/GeneratedTagMetadata.g.cs` is deterministic checked-in code generated from the exact AngleSharp
...
csharpier format dom/src/AngleSharp.ReadOnlyDom/Generated/GeneratedTagMetadata.g.cs dom/src/AngleSharp.ReadOnlyDom.Compact/GeneratedTagMetadata.g.cs
```
