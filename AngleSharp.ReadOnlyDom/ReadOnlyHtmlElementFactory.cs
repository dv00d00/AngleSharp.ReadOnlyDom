...
internal sealed class ReadOnlyDomConstructionFactory : IReadOnlyConstructionFactory
{
    ...
    public ReadOnlyHtmlElement CreateNoScript(ReadOnlyDocument document, bool scripting) =>
        new(document, TagNames.NoScript, default, NodeFlags.Special);
    ...
    private static readonly Dictionary<StringOrMemory, Creator> Creators = new()
    {
        {
            TagNames.Address,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Address, prefix, NodeFlags.Special)
        },
        {
            TagNames.A,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.A, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Applet,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Applet, prefix, NodeFlags.Special | NodeFlags.Scoped)
        },
        {
            TagNames.Area,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Area, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        { TagNames.Audio, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Audio, prefix) },
        {
            TagNames.Base,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Base, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.BaseFont,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.BaseFont, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.Bgsound,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Bgsound, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.Big,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Big, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Body,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Body, prefix, NodeFlags.Special | NodeFlags.ImplicitlyClosed)
        },
        {
            TagNames.B,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.B, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Br,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Br, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        ...
        {
            TagNames.Code,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Code, prefix, NodeFlags.HtmlFormatting)
        },
        ...
        {
            TagNames.Dl,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Dl, prefix, NodeFlags.Special)
        },
        {
            TagNames.Details,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Details, prefix, NodeFlags.Special)
        },
        { TagNames.Dialog, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Dialog, prefix) },
        {
            TagNames.Dir,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Dir, prefix, NodeFlags.Special)
        },
        {
            TagNames.Div,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Div, prefix, NodeFlags.Special)
        },
        {
            TagNames.Embed,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Embed, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.Em,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Em, prefix, NodeFlags.HtmlFormatting)
        },
        { TagNames.Fieldset, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Fieldset, prefix) },
        {
            TagNames.Font,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Font, prefix, NodeFlags.HtmlFormatting)
        },
        { TagNames.Form, (document, prefix) => new ReadOnlyHtmlFormElement(document, prefix) },
        {
            TagNames.Frame,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Frame, prefix, NodeFlags.SelfClosing)
        },
        {
            TagNames.Frameset,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Frameset, prefix, NodeFlags.Special)
        },
        {
            TagNames.Head,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Head, prefix, NodeFlags.Special)
        },
        {
            TagNames.Hr,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Hr, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.Html,
            (document, prefix) =>
                new ReadOnlyHtmlElement(
                    document,
                    TagNames.Html,
                    prefix,
                    NodeFlags.Special
        ...
        {
            TagNames.Iframe,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Iframe, prefix, NodeFlags.LiteralText)
        },
        {
            TagNames.Img,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Img, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.Input,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Input, prefix, NodeFlags.SelfClosing)
        },
        {
            TagNames.IsIndex,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.IsIndex, prefix, NodeFlags.Special)
        },
        {
            TagNames.I,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.I, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Keygen,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Keygen, prefix, NodeFlags.SelfClosing)
        },
        ...
        { TagNames.Legend, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Legend, prefix) },
        {
            TagNames.Link,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Link, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        { TagNames.Map, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Map, prefix) },
        {
            TagNames.Marquee,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Marquee, prefix, NodeFlags.Special | NodeFlags.Scoped)
        },
        {
            TagNames.Menu,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Menu, prefix, NodeFlags.Special)
        },
        {
            TagNames.MenuItem,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.MenuItem, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.Meta,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Meta, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        { TagNames.Meter, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Meter, prefix) },
        {
            TagNames.NoEmbed,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.NoEmbed, prefix, NodeFlags.Special | NodeFlags.LiteralText)
        },
        {
            TagNames.NoFrames,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.NoFrames, prefix, NodeFlags.Special | NodeFlags.LiteralText)
        },
        {
            TagNames.NoBr,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.NoBr, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.NoScript,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.NoScript, prefix, NodeFlags.Special) /*GetFlags(scripting ?? owner.Context.IsScripting()))*/
        },
        {
            TagNames.Object,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Object, prefix, NodeFlags.Scoped)
        },
        {
            TagNames.Option,
            (document, prefix) =>
        ...
        },
        {
            TagNames.Ol,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Ol, prefix, NodeFlags.Special | NodeFlags.HtmlListScoped)
        },
        ...
        },
        {
            TagNames.Param,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Param, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        { TagNames.Picture, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Picture, prefix) },
        {
            TagNames.Pre,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Pre, prefix, NodeFlags.Special | NodeFlags.LineTolerance)
        },
        { TagNames.Progress, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Progress, prefix) },
        {
            ...
            (document, prefix) =>
                new ReadOnlyHtmlElement(
                    ...
                    TagNames.Rb,
                    prefix,
                    NodeFlags.ImplicitlyClosed | NodeFlags.ImpliedEnd
                )
        },
        {
            TagNames.Rp,
        ...
        { TagNames.Ruby, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Ruby, prefix) },
        {
            TagNames.Script,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Script, prefix, NodeFlags.Special | NodeFlags.LiteralText)
        },
        ...
        {
            TagNames.Small,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Small, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Source,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Source, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        { TagNames.Span, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Span, prefix) },
        {
            TagNames.Strike,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Strike, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Strong,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Strong, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.S,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.S, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Style,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Style, prefix, NodeFlags.Special | NodeFlags.LiteralText)
        },
        {
            TagNames.Caption,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Caption, prefix, NodeFlags.Special | NodeFlags.Scoped)
        },
        {
            TagNames.Col,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Col, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.Colgroup,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Colgroup, prefix, NodeFlags.Special)
        },
        ...
        { TagNames.Th, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Th, prefix) },
        {
            TagNames.Tr,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Tr, prefix, NodeFlags.Special | NodeFlags.ImplicitlyClosed)
        },
        {
            TagNames.Tt,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Tt, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Template,
            (document, prefix) =>
        ...
        {
            TagNames.Textarea,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Textarea, prefix, NodeFlags.LineTolerance)
        },
        {
            TagNames.Time,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Time, prefix, NodeFlags.Special)
        },
        {
            TagNames.Title,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Title, prefix, NodeFlags.Special)
        },
        {
            TagNames.Track,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Track, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.U,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.U, prefix, NodeFlags.HtmlFormatting)
        },
        {
            TagNames.Ul,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Ul, prefix, NodeFlags.Special | NodeFlags.HtmlListScoped)
        },
        { TagNames.Video, (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Video, prefix) },
        {
            TagNames.Wbr,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Wbr, prefix, NodeFlags.Special | NodeFlags.SelfClosing)
        },
        {
            TagNames.Xmp,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Xmp, prefix, NodeFlags.Special | NodeFlags.LiteralText)
        },
        {
            TagNames.Li,
            (document, prefix) =>
        ...
        {
            TagNames.H1,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.H1, prefix, NodeFlags.Special)
        },
        {
            TagNames.H2,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.H2, prefix, NodeFlags.Special)
        },
        {
            TagNames.H3,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.H3, prefix, NodeFlags.Special)
        },
        {
            TagNames.H4,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.H4, prefix, NodeFlags.Special)
        },
        {
            TagNames.H5,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.H5, prefix, NodeFlags.Special)
        },
        {
            TagNames.H6,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.H6, prefix, NodeFlags.Special)
        },
        {
            TagNames.BlockQuote,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.BlockQuote, prefix, NodeFlags.Special)
        },
        ...
        {
            TagNames.Main,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Main, prefix, NodeFlags.Special)
        },
        {
            TagNames.Summary,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Summary, prefix, NodeFlags.Special)
        },
        {
            TagNames.Center,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Center, prefix, NodeFlags.Special)
        },
        {
            TagNames.Listing,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Listing, prefix, NodeFlags.Special)
        },
        {
            TagNames.Nav,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Nav, prefix, NodeFlags.Special)
        },
        {
            TagNames.Article,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Article, prefix, NodeFlags.Special)
        },
        {
            TagNames.Aside,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Aside, prefix, NodeFlags.Special)
        },
        {
            TagNames.Figcaption,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Figcaption, prefix, NodeFlags.Special)
        },
        {
            TagNames.Figure,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Figure, prefix, NodeFlags.Special)
        },
        {
            TagNames.Section,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Section, prefix, NodeFlags.Special)
        },
        {
            TagNames.Footer,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Footer, prefix, NodeFlags.Special)
        },
        {
            TagNames.Header,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Header, prefix, NodeFlags.Special)
        },
        {
            TagNames.Hgroup,
            (document, prefix) => new ReadOnlyHtmlElement(document, TagNames.Hgroup, prefix, NodeFlags.Special)
        },
        {
            TagNames.Plaintext,
            (document, prefix) =>
                new ReadOnlyHtmlElement(document, TagNames.Plaintext, prefix, NodeFlags.Special | NodeFlags.LiteralText)
        },
